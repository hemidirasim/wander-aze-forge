  ...
  try {
    ...
    try {
      ...
      const updateValues = [
        ...
        tourData.providedEquipment ? JSON.stringify(tourData.providedEquipment) : '[]',
        tourData.whatToBring ? JSON.stringify(tourData.whatToBring) : '[]',
        tourData.transportDetails,
        tourData.pickupService,
        tourData.galleryImages ? JSON.stringify(tourData.galleryImages) : '[]',
        tourData.photographyService,
        tourData.priceIncludes ? JSON.stringify(tourData.priceIncludes) : '[]',
        tourData.groupDiscounts,
        tourData.earlyBirdDiscount,
        tourData.contactPhone,
        tourData.bookingTerms,
        tourData.highlights ? JSON.stringify(tourData.highlights) : '[]',
        tourData.includes ? JSON.stringify(tourData.includes) : '[]',
        tourData.excludes ? JSON.stringify(tourData.excludes) : '[]',
        tourData.itinerary,
        tourData.requirements,
        tourData.specialFields ? JSON.stringify(tourData.specialFields) : '{}',
        tourData.tour_programs ? JSON.stringify(tourData.tour_programs) : '[]',
        tourData.isActive,
        tourData.featured,
        result.rows[0].id
      ];
