...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { 
      icon: () => (
        <svg fill="currentColor" width="20px" height="20px" viewBox="0 0 14 14" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-900">
