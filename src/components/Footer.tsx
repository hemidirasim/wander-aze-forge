              ...
              <div className="flex space-x-3">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-8 h-8 border border-gray-900 hover:bg-primary hover:border-primary rounded-lg flex items-center justify-center transition-colors"
                    aria-label={social.name}
                  >
                    <social.icon className="w-4 h-4 text-gray-900 hover:text-white transition-colors" />
                  </a>
                ))}
              </div>
            </div>
