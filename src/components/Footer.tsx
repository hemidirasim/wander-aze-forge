...
const Footer = () => {
  ...
  const socialLinks = (() => {
    ...
    add(t?.twitter, (props: any) => (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 509.64" {...props}>
      ...
      <div className="container mx-auto footer-padding py-16">
        <div className="flex flex-col lg:flex-row gap-8 mb-12">
          ...
          <div className="lg:w-1/2 flex flex-col md:flex-row gap-8 justify-center items-center md:items-start">
            {/* Quick Links */}
            <div className="hidden md:block md:w-1/2 space-y-4 text-center md:text-left">
        ...
        <div className="border-t border-gray-300 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <Link to="/support" className="text-gray-900 hover:text-primary transition-colors">
                Support
              </Link>
